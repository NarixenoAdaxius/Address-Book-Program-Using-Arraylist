...
public class AddressBookPrg {
    ...
    public static void main(String[] args) {
        ...
        switch (input) {
            ...
            case "2":
                System.out.println("Enter the index(starts in 0) of the entry, which you want to delete:");
            ...
            case "3":
                ...
                break;
            case "4":
                System.out.println("Enter the index(starts in 0) of the entry, which you want to update:");
